...
<head>
    ...
    <title>Notificaciones - Mall Gran Vía</title>
...
<body>
    ...
    <div class="page-header">
        <div class="container-fluid px-3 px-md-4">
            ...
            <p>Mantente informado de ofertas y actualizaciones</p>
        </div>
    </div>
    ...
    <main class="container-fluid px-3 px-md-4">
        <div class="empty-state-container">
            ...
            <h2 class="empty-state-title">Aún no tienes notificaciones</h2>
            <p class="empty-state-text">Recibirás notificaciones sobre nuevas ofertas, cambios en productos que sigues y actualizaciones importantes de Mall Gran Vía.</p>
            <div class="empty-state-buttons">
                <a href="{{ route('dashboard') }}" class="btn-secondary-custom">
                    <i class="bi bi-house-fill me-2"></i>Volver al dashboard
                </a>
                <a href="{{ route('superofertas.index') }}" class="btn-primary-custom">
                    <i class="bi bi-lightning-charge-fill me-2"></i>Ver SuperOfertas
                </a>
            </div>
        </div>
    </main>
