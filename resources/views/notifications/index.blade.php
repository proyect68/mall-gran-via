...
@section('title', 'Notificaciones - Mall Gran Vía')
...
<main class="container-fluid px-3 px-md-4">
    <div class="empty-state-container">
        ...
        <p class="empty-state-text">
            Recibirás notificaciones sobre nuevas ofertas, cambios en productos que sigues
            y actualizaciones importantes de Mall Gran Vía.
        </p>
