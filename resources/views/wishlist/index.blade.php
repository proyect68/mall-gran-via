...
<head>
    ...
    <title>Lista de Deseos - Mall Gran Vía</title>
...
<body>
    ...
    <div class="page-header">
        <div class="container-fluid px-3 px-md-4">
            <h1><i class="bi bi-heart"></i> Mi Lista de Deseos</h1>
            <p>Guarda tus productos favoritos para verlos después</p>
        </div>
    </div>
    ...
    <main class="container-fluid px-3 px-md-4">
        <div class="empty-state-container">
            ...
            <h2 class="empty-state-title">Aún no hay productos agregados a tu lista de deseos</h2>
            <p class="empty-state-text">Comienza a agregar productos a tu lista de deseos y los verás aquí. Podrás acceder a ellos en cualquier momento.</p>
            <div class="empty-state-buttons">
                <a href="{{ route('dashboard') }}" class="btn-secondary-custom">
                    <i class="bi bi-house-fill me-2"></i>Volver al dashboard
                </a>
                <a href="{{ route('stores.index') }}" class="btn-primary-custom">
                    <i class="bi bi-shop me-2"></i>Explorar tiendas
                </a>
            </div>
        </div>
    </main>
